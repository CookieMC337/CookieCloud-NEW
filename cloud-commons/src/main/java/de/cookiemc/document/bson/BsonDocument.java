package de.cookiemc.document.bson;
...
import de.cookiemc.document.abstraction.AbstractDocument;
...
public class BsonDocument extends AbstractDocument implements DocumentWrapper<Document> {
	...
	@Nonnull
	@Override
	public de.cookiemc.document.Document getDocument(@Nonnull String path) {
	...
	@Override
	public Document getWrapper() {
		return (Document) this.bsonDocument;
	}
}
