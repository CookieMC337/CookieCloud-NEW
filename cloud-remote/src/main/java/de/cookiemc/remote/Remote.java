...
import de.cookiemc.driver.storage.RemoteNetworkDocumentStorage;
...
import de.cookiemc.remote.impl.*;
import de.cookiemc.remote.impl.*;
import de.cookiemc.remote.impl.handler.RemoteLoggingHandler;
import de.cookiemc.remote.impl.handler.RemoteNodeUpdateHandler;
import de.cookiemc.remote.impl.log.DefaultLogHandler;
import de.cookiemc.remote.impl.module.RemoteModuleManager;
...
public class Remote extends CloudDriver<ICloudServer> {
    ...
    public @NotNull <E extends IBufferObject> Task<ISyncedNetworkPromise<E>> getSyncedNetworkObjectAsync(SyncedObjectType<E> type, String queryParameters) {
        Task<ISyncedNetworkPromise<E>> task = Task.empty();
