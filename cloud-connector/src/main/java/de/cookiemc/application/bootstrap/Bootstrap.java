...
package de.cookiemc.application.bootstrap;
...
import de.cookiemc.application.elements.data.CloudTheme;
        ...
        Remote.initFromOtherInstance(RemoteIdentity.forApplication(new ProtocolAddress(host, port, key)), packet -> {
            ...
            Task.runAsync(() -> {
                try {
                    ...
                    GHRepository repository = github.getRepository("CookieMC337/CookieCloud");
