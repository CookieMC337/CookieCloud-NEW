...
package de.cookiemc.application.gui;
...
import de.cookiemc.application.elements.data.ApplicationData;
import de.cookiemc.application.elements.StartPanelInfoBox;
import de.cookiemc.application.gui.panels.*;
...
public class Application extends JFrame {
    ...
    private void selectedTabChanged() {
        ApplicationData.getCurrent().setLastOpenedTab(tabbedPane.getSelectedIndex());
    }
    ...
    public void init() throws IOException {
        ...
        refreshButton.setIcon(new FlatSVGIcon("de/cookiemc/img/refresh.svg"));
