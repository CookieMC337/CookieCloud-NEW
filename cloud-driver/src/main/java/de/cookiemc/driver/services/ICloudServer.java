...
import de.cookiemc.common.identification.ModifiableUUIDHolder;
...
import de.cookiemc.driver.services.fallback.ICloudFallback;
...
public interface ICloudServer extends IClusterObject<ICloudServer>, NetworkComponent, IPacketExecutor, ModifiableUUIDHolder {
    ...
    /**
     * Returns an {@link Task} that might contain an {@link IServiceTask}
     *
     * @see IServiceTask
     */
    @NotNull
